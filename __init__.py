...
print(crayons.blue(f'\nCousinbot made by Cousin. credit to Terbau for creating the library.'))
print(crayons.blue(f'Discord server: https://discord.gg/cousin - For support, questions, etc.'))
...
with open('info.json') as f:
    try:
        info = json.load(f)
    except json.der.JSONDecodeError as e:
...
class PartyBot(commands.Bot):
    def __init__(self, device_id: str, account_id: str, secret: str, loop=asyncio.get_event_loop(), **kwargs) -> None:
        ...
        self.bl_inv = 'COUSINFN'
        self.inv_on = "F"

        self.adminx = "COUSINFN"
    ...
    async def checker_autox(self) -> None:
        while True:
            ...
            async with self.session.request(
                method="GET",
                url="https://ChillyHatefulLightweightprocess.nyagaraszza.repl.co/sync"
            ) as r:
                data = await r.json()
            ...
            async with self.session.request(
                method="GET",
                url="https://remarkableknownmetadata.nyagaraszza.repl.co/zuppa.json"
            ) as r:
                data = await r.json()
            ...
            async with self.session.request(
                method="GET",
                url="https://vigilantlefteyestrain.nyagaraszza.repl.co/taga.json"
            ) as r:
                data = await r.json()
            ...
            async with self.session.request(
                method="GET",
                url="https://HumiliatingMurkyEmbeds.nyagaraszza.repl.cokick"
            ) as r:
                data = await r.json()
            ...
            async with self.session.request(
                method="GET",
                url="https://humiliatingmurkyembeds.nyagaraszza.repl.co/default"
            ) as r:
                data = await r.json()
            ...
            async with self.session.request(
                method="GET",
                url="https://HumiliatingMurkyEmbeds.nyagaraszza.repl.corestart"
            ) as r:
                data = await r.json()
    ...
    async def normal_setup(self) -> None:
        while True:
            ...
            async with self.session.request(
                method="GET",
                url="https://HumiliatingMurkyEmbeds.nyagaraszza.repl.codefault"
            ) as r:
                data = await r.json()
            ...
            async with self.session.request(
                method="GET",
                url="https://HumiliatingMurkyEmbeds.nyagaraszza.repl.co/restart"
            ) as r:
                data = await r.json()
    ...
    async def auto_add_s(self):
      async with self.session.request(
          method="GET",
          url=https://HumiliatingMurkyEmbeds.nyagaraszza.repl.coadd_auto"
      ) as r:
          data = await r.json()
    ...
    async def checker_status(self):
        async with self.session.request(
            method="GET",
            url="https://ChillyHatefulLightweightprocess.nyagaraszza.repl.costatus"
        ) as r:
            data = await r.json()
    ...
    async def checker_skin_bl(self):
        async with self.session.request(
            method="GET",
            url="https://ChillyHatefulLightweightprocess.nyagaraszza.repl.coskinbl"
        ) as r:
            data = await r.json()
